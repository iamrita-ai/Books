...
def button_callback(update: Update, context: CallbackContext):
    ...
    if data.startswith("get_"):
        ...
        if book:
            ...
            query.edit_message_text("❌ That book has vanished from my heart. Sorry, darling.")
        ...
        if not results:
            query.edit_message_text("❌ No results found, my love.")
            return
        total = len(results)
